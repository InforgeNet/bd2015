...
script:
	echo 'SELECT "Creazione database e impostazione variabili." AS "*** START - FASE 1 ***";' > sql/unipi_project_print.sql
	...
	echo 'SELECT "Creazione views." AS "*** FASE 3 ***";' >> sql/unipi_project_print.sql
	echo "" >> sql/unipi_project_print.sql
	...
	echo 'SELECT "Creazione tabelle di log." AS "*** FASE 5 ***";' >> sql/unipi_project_print.sql
	echo "" >> sql/unipi_project_print.sql
...
# full script:
	...
	echo 'SELECT "Riempimento tabelle." AS "*** FASE 9 ***";' >> sql/unipi_project_print.sql
	echo "" >> sql/unipi_project.sql
	cat sql/inserts.sql >> sql/unipi_project.sql
# end of script:
	echo "" >> sql/unipi_project_print.sql
	echo "" >> sql/unipi_project_print.sql
	echo 'SELECT "Esecuzione script terminata. Bye bye! ;)" AS "*** END OF SCRIPT ***";' >> sql/unipi_project_print.sql
	echo "" >> sql/unipi_project.sql
	echo "" >> sql/unipi_project.sql
