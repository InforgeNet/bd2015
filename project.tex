\documentclass[11pt,draft]{report}  % dimensione di default del font e "draft" indica che si tratta di una 'brutta copia' (in sviluppo):
...
%\usepackage{geometry}      % figure geometriche
