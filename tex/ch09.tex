...
non permette i {\it vincoli di integrità referenziale} che sono fondamentali in questo database. Dobbiamo
quindi utilizzare {\tt InnoDB} e {\it simulare} l'{\tt AUTO\_INCREMENT} mediante trigger.

Le funzionalità di {\it back-end} per l'{\it Area Analytics} sono implementate nella parte finale dello {\it script}.
